...
*	nl nonlin @ lnms_pays uv_presente  [iweight=value], iterate(100) parameters(lnsigmaminus1  ) initial(lnsigmaminus1 `startlnsigmaminus1' )
	nl nonlin @ lnms_pays uv_presente [iweight=value], eps(1e-7) iterate(100) parameters(lnsigmaminus1  ) initial(lnsigmaminus1 `startlnsigmaminus1' )
...
*foreach year of num 2009(-20)1962 {
*	display "`year'"
*	display
