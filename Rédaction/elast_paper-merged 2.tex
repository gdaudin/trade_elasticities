...
This can be compared with the equivalent period in our original dataset: the increase in the estimated $\left(1-\sigma right)$ is much steeper: 1.18\% a year instead of 0.4\%.
