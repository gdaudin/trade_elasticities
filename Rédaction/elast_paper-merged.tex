...
\newcommand\hmmax{0}
\newcommand\bmmax{0}
%pour lutter contre l’erreur "Too many math alphabets used in version normal
...
Citer https://voxeu.org/article/armington-elasticity-and-international-trade-models-fifty-years : ce n’est pas la même elasticité, mais il y a des signes qu’elle augmente au cours du temps.
...
more back-and-forth traveling, between upstream and downstream firms.
...
Our results are consistent with \cite{Akerman2020} who document an increase in the price elasticity of demand for exports and imports of Norwegian firms following the roll-out of broadband internet. The theoretical mechanism that the authors use to rationalize their findings underpins how the reduction of trade barriers may lead to a higher trade elasticity. In their model, adoption of technology that reduces information frictions expands the set of available suppliers, facilitating substitution away from products that become relatively expensive. Consequently, demand becomes more responsive to differences in trade costs across markets, providing an explanation of the distance puzzle. 
