...
=======
Consistently with \cite{Head2013}, we find that the distance sensitivity of trade is best described as stable when the gravity model is estimated using the PPML.
>>>>>>> drafting changes part 1
...
=======
\cite{Mayer2019} and \cite{Head2013} argue that the main consequence of choosing to estimate the model in multiplicative rather than in the loglinearized form is the relative weight given to small and big trade flows. 
Also, \cite{Head2013} document that the loglinearized model picks up a stronger increase in the distance elasticity of trade, mainly because of the increasing number of new low volume trade relationships. 
>>>>>>> drafting changes part 1
