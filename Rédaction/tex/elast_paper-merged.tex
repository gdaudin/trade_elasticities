...
Have trade flows become more sensitive to trade costs (increasing $ |\epsilon| $), or have trade costs become more sensitive to distance (increasing $\rho$)? In section {\hyperref[ref-003]{3}} we estimate the evolution of $ |\epsilon| $ to deduce the evolution of $ \rho $.
...
In this section, we provide details on the procedure used in this paper to estimate the evolution of $ |\epsilon| $ in the Armington framework.
