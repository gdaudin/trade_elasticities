...
The perceived substitutability of imported sectoral goods can be estimated on the basis of the distribution of prices and of market shares in each destination market.
...
The basic intuition of the method we use starts from the well-known result that assuming a CES utility function, demand for an exporter-specific variety in the one-good Armington framework is:
...
\subsubsection{ \label{ref-004}The incidence of missing unit values\label{mark-2.1.}}
...
The accuracy of the relative prices of country-composite goods constructed with this dataset is improved because the harmonization procedure applied by (Gaulier et Zignago 2010).
...
Another advantage is that the share of ztf in BACI is stable in 1995-2016 (between 0.94\% and 0.96\%)as opposed to relatively strong fluctuations in the share of ztf over time in our original dataset.
