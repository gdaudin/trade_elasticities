...
But \cite{ChaneyThomas2018} provides a theoretical foundation for the gravity equation through the lens of network analysis which demonstrates that the distance coefficient can be invariant to the trade cost function.
In \cite{ChaneyThomas2018} the rate of distance decay in aggregate trade is linked to the rate of decay in the density of firms which cover that distance with their network of contacts.
