...
We therefore settle for the GDP deflator and the investment deflator as alternative proxies of shocks to exporter-specific prices. 

The \if 0 price level of \fi GDP price deflator will be a valid instrument if demand shocks in the importing country are the main source of price endogeneity, and the small country assumption holds.\footnote{\cite{Magee2008} provide evidence that the small country assumption likely holds in the data.}
