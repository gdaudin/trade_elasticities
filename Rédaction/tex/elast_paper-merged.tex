...
\subsubsection{Estimation of $(1-\sigma)$ with instrumented prices \label{mark-2.3.2.}}
...
Specifically, whenever the supply curve has a finite slope, unobserved demand shocks will result in a simultaneous increase in the price and in the expenditure on sector \textit{k} products.\footnote{\cite{Broda2006} find that supply elasticities are finite at the 4-digit level. Their findings differ from \cite{Magee2008} who find that the small country assumption may hold in the data.} 
