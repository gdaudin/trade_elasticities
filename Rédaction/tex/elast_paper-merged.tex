...
%We evaluate the direction and magnitude of the possible bias that missing unit values and zero trade flows may introduce in the estimation of the aggregate trade elasticity. 
