...
%But the canonical microfoundations of the gravity model rely on the implicit assumption of stability in the structural parameters. 
...
On the supply side, there is no direct evidence on the evolution of the structural parameter that captures technological dissimilarity in production. 
\cite{Levchenko2016} is the only paper that looks into the dissimilarity of technology at the intersectoral level over a 50 year horizon.
Although \cite{Levchenko2016} do not estimate the Ricardian structural heterogeneity parameter, they find evidence of within-country convergence in sectoral knowledge stocks over 1960-2010.\footnote{Different theoretically grounded methods have been used to estimate intersectoral productivity dispersion, i.e. the trade elasticity in the Ricardian framework, but only in a specific year. See \cite{Eaton2002}; \cite{Simonovska2014}; \cite{Costinot2012a}; \cite{Caliendo2015}.} 
...
Reduced dispersion in sectoral productivity draws would translate into an increasing trade elasticity $|\epsilon|$ in the Ricardian framework.
...
Working with a sample that covers 24 OECD countries, \cite{Andrews2016} find evidence of increasing productivity dispersion over 1997-2014 in the set of surviving firms. 
But this finding may be a consequence of increasingly integrated global markets and would require further work to identify a possible underlying shift in the structural parameter of the Melitz-Chaney framework. 
Indeed, \cite{DiGiovanni2011} have shown that measured productivity dispersion among firms of which some are exporters is systematically higher than the underlying `true' extent of technological heterogeneity among domestic firms.
Further, this wedge is more pronounced in sectors that are more open to trade.
As shown by \cite{Autor2017}, the weight of foreign sales in total sales of US frontier firms increased significantly over  1982-2012, underscoring that the findings of \cite{Andrews2016} likely pick up the increasing importance of foreign sales in  the measured productivity of the so called `frontier' firms. 
