...
%We assess the evolution of the trade elasticity in the canonical \cite{Anderson2003a} framework in which structural heterogeneity captures the degree of product differentiation by place of production.
...
%This elasticity is the structural parameter which determines the elasticity of trade flows to trade costs in the canonical \cite{Anderson2003a} framework.
...
In the Melitz-Chaney framework the heterogeneity dimension captured by the trade elasticity $ |\epsilon| $ is intrasectoral.\footnote{\cite{Melitz2003}, \cite{Chaney2008}.}
...
A shock to consumer preferences or to the shape parameter of the productivity distribution would be required. This implicit assumption of stability in the structural parameters, common across models, may contribute to explain the scant empirical evidence on the evolution of sectoral or aggregate trade elasticities in either model.\footnote{See also  discussion in \cite{Head2013}, p.1209.}
...
Different theoretically grounded methods have been used to estimate the intersectoral productivity dispersion parameter, i.e. the trade elasticity in the Ricardian framework, but only in a specific year.\footnote{\cite{Eaton2002}; \cite{Simonovska2014}; \cite{Costinot2012}; \cite{Caliendo2012}.}  \cite{Levchenko2011} is the only paper that documents  the evolution of intersectoral productivity dispersion. They find evidence of within-country convergence in sectoral knowledge stocks over 1960-2010.
...
Reduced dispersion in intersectoral productivity would translate into an increasing trade elasticity in the Ricardian framework.
