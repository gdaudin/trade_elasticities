...
The defining feature of the trade elasticity, common to the three frameworks, is that it captures the extent of structural heterogeneity in the economy. 
Specific functional form assumptions in these canonical derivations of the gravity equation deliver the result that the trade elasticity depends either on the dissimilarity of production technologies or on the dissimilarity of products as perceived by consumers. 
As pointed out by \cite{Head2014}, the trade elasticity depends on supply- and demand-side heterogeneity under less restrictive assumptions.
The bottom line is that trade flows become more responsive to trade costs in more homogeneous economies.
The open question is whether shocks to structural parameters can be identified with the trade data at hand.   
