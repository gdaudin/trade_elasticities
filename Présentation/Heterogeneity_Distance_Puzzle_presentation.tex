...
\institute{ \inst{*} SciencesPo/OFCE
  \and
  \inst{**} Lille-I/EQUIPPE and  Sciences-Po/OFCE
}
\date{July 2012
%\today
\\
...
\vspace{0.2cm}
\begin{itemize}
\item seems obvious to most observers of globalization
\item but conflicting evidence in gravity equations:  
\item trade more sensitive to distance since 1960s 
...
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip, height=2.5in]{graph1.pdf}}
\end{center}
\end{figure}
%\vspace{0.3cm}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip,height=2.5in]{graph3.pdf}}
\end{center}
\end{figure}
%\vspace{0.3cm}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip,height=2.5in]{graph5.pdf}}
\end{center}
\end{figure}
\end{frame}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip,height=2.5in]{graph4.pdf}}
\end{center}
\end{figure}
\end{frame}
\fi
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip,height=2.5in]{graph6.pdf}}
\end{center}
\end{figure}
\end{frame}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm, clip,height=2.5in]{fta_proximity.pdf}}
\end{center}
\end{figure}
\end{frame}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[trim = 0mm 0mm 0mm 9.5mm,clip,height=2.6in]{elast_real_0digit.eps}}
\end{center}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
%\fbox{\includegraphics[0 trim = 0mm 0mm 0mm 9.5mm,clip,height=2.6in]{elast_bench.eps}}
\fbox{\includegraphics[height=2.5in]{elast_bench.eps}}
\end{center}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[height=2.5in]{elast_baci_1995_2009.eps}}
\end{center}
...
\setlength{\fboxrule}{1pt} %makes border lines thick
\setlength{\fboxsep}{.1in} %increases distance to border
\fbox{\includegraphics[height=2.5in]{elast_l1_l10.eps}}
\end{center}
